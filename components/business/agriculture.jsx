...
import BusinessProjectDetailAgriculture from "../model/business-project-detail-agriculture";
import BannerSubpage from "../sections/banner-subpage";

function AgricultureBusiness({ dataset, menus }) {
  const [expanded, setExpanded] = useState(true);
  const [selectedIndex, setSelectedIndex] = useState("mixed-farming");
    ...
    <div>
      ...
      <div className="section-padding-model">
        <Container maxWidth="lg">
          ...
          <div className="mb-10">
            <BusinessProjectDetailAgriculture
              expanded={expanded}
              data={dataset.find(
                (item) =>
...
export default AgricultureBusiness;
