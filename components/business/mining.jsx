...
import BusinessProjectDetailMining from "../model/business-project-detail-mining";
import { useSelector } from "react-redux";
import BannerSubpage from "../sections/banner-subpage";

function MiningBusiness({ dataset, menus }) {
  const [expanded, setExpanded] = useState(true);
  const [selectedIndex, setSelectedIndex] = useState("mining");
