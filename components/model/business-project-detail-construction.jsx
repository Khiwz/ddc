...
function BusinessProjectDetailConstruction({ expanded, data }) {
  return (
          ...
          {data?.description?.map((item, index) => (
            <div key={index}>
              {item.indicator === "title" ? (
                <p className="text-xl font-bold mt-2">{item.desc}</p>
              ) : item.indicator === "sub" ? (
                <div>
                ...
                <div className="mb-4 text-justify text-sm">{item.desc}</div>
              )}
            </div>
          ))}
        </div>
              ...
              >
                ...
                {item?.itemDetail?.map((detail, i) => (
                  ...
                  <div className="flex-1 overflow-hidden">
                    <p className="text-xs lg:text-lg font-bold uppercase mb-2">
                      {item.name}
                    </p>
                    <div className="mb-3">
                      <div className="h-1 w-20 bg-web-yellow" />
...
export default BusinessProjectDetailConstruction;
