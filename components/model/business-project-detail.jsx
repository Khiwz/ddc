...
const itemDetail = [
  ...
  <BsCurrencyDollar key="3" className="w-full h-full" />,
  <FaCalendarAlt key="4" className="w-full h-full" />,
  <BsGearFill key="5" className="w-full h-full" />,
  <BiShapeTriangle key="6" className="w-full h-full" />,
  ...
  <BiAnalyse key="11" className="w-full h-full" />,
  <FaPeopleArrows key="12" className="w-full h-full" />,
];

function BusinessProjectDetail({ expanded, data }) {
  return (
