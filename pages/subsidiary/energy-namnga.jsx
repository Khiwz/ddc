...
const pageInfo = {
  subsiName: {
    lao: "ບໍລິສັດ ນ້ຳງາ ຈະເລີນພາວເວີ້ ຈຳກັດ ຜູ້ດຽວ",
    english: "NUMGNA CHALERN POWER SOLE CO.,LTD",
    chiness: "NUMGNACHALERN POWER SOLE CO.,LTD",
  },
  subsiDescription: {
  ...
  subsiImage: [
    {
      img: "/images/subsi/nam-nga/organizational-chart.jpg",
      description: {
        lao: "ໂຄງຮ່າງການຈັດຕັ້ງຂອງ ບໍລິສັດ ນ້ຳງາຈະເລີນພາວເວີ້ ຈຳກັດ",
        english:
          "Organizational structure of Nam Nga Chalern Power Company Limited",
  ...
  address: {
    lao: "ເມືອງນ້ຳບາກ ແຂວງຫຼວງພະບາງ",
    english: "Nambak District, Luang Prabang Province",
    chiness: "瑯勃拉邦省難波區",
  },
  workingHour: {
...
function EnergyNamnagPage({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default EnergyNamnagPage;
