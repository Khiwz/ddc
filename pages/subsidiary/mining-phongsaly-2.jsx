...
const pageInfo = {
  ...
  subsiName: {
    lao: "ບໍລິສັດ ກຸ່ມດວງຈະເລີນພັດທະນາບໍ່ແຮ່ຖ່ານຫີນ ຜົ້ງສາລີ II ຈຳກັດ",
    english: "DUANGCHALERN DEVELOPMENT COAL MINING PHONGSALY II CO.,LTD",
    chiness: "DUANGCHALERN DEVELOPMENT COAL MINING PHONGSALY II CO.,LTD",
  },
  subsiDescription: {
    lao: "ດຳເນີນກິດຈະການຊອກຄົ້ນ ແລະ ສຳຫຼວດແຮ່ຖ່ານຫີນ ໃນເຂດບ້ານຫຼັກ5 ເມືອງຜົ້ງສາລີ ແຂວງຜົ້ງສາລີ ໃນເນື້ອທີ່ 299,2 ຕາລາງກິໂລແມັດ. ໃຊ້ທຶນໃນການຂຸດຄົ້ນທັງໝົດຫຼາຍກວ່າ 598.140 ໂດລາສະຫາລັດ.",
    english:
      "Conduct exploration and exploration activities for coal ore In the main village Luk5, Phongsaly district, Phongsaly province in an area of 299,2 square kilometers. Spending more than 598.140 dollars on the total mining operation.",
    chiness:
      "進行煤炭的勘探和勘探活動 豐沙麗省豐沙麗區主村5區 面積 299,2平方公里。在整個採礦業務上花費超過 598.140 美元。",
  },
  subsiImage: [
    {
      img: "/images/subsi/coal-phongsaly-2/organizational-chart.jpg",
      description: {
        lao: "ໂຄງຮ່າງການຈັດຕັ້ງຂອງ ບໍລິສັດ ກຸ່ມດວງຈະເລີນພັດທະນາບໍ່ແຮ່ຖ່ານຫີນ ຜົ້ງສາລີ II ຈຳກັດ",
        english:
          "ORGANIZATIONAL CHART OF DUANGCHALERN DEVELOPMENT COAL MINING PHONGSALY II CO.,LTD",
        chiness:
          "ORGANIZATIONAL CHART OF DUANGCHALERN DEVELOPMENT COAL MINING PHONGSALY II CO.,LTD",
      },
    },
    {
      img: "/images/subsi/coal-phongsaly-2/coal-excavation-1.jpg",
      description: {
    ...
    {
      img: "/images/subsi/coal-phongsaly-2/coal-excavation-2.jpg",
      description: {
    ...
    {
      img: "/images/subsi/coal-phongsaly-2/coal-excavation-3.jpg",
      description: {
...
function MiningPhongsaly2Page({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default MiningPhongsaly2Page;
