...
const pageInfo = {
  subsiName: {
    lao: "ບໍລິສັດ ນ້ຳໂມ້ ຈະເລີນພາວເວີ້ ຈຳກັດ",
    english: "NAMMO CHALERN POWER",
    chiness: "NAMMO CHALERN POWER",
  },
  subsiDescription: {
  ...
  subsiImage: [
    {
      img: "/images/subsi/nam-mo/organizational-chart.jpg",
      description: {
        lao: "ໂຄງຮ່າງການຈັດຕັ້ງຂອງ ບໍລິສັດ ນ້ຳໂມຈະເລີນພາວເວີ້ ຈຳກັດ",
        english:
          "Organizational structure of Nam Mo Chalern Power Company Limited",
...
function EnergyNammoPage({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default EnergyNammoPage;
