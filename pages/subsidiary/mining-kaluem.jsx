...
const pageInfo = {
  subsiName: {
    lao: "ບໍລິສັດ ດວງຈະເລີນພັດທະນາແຮ່ຄຳກະລຶມ ຈຳກັດ",
    english: "DUANGCHALERN DEVELOPMENT KALUEM GOLD MINING CO., LTD",
    chiness: "DUANGCHALERN DEVELOPMENT KALUEM GOLD MINING CO., LTD",
  },
  subsiDescription: {
    lao: "ດຳເນີນກິດຈະການຊອກຄົ້ນ ແລະ ສຳຫຼວດແຮ່ຄຳ ໃນເຂດເມືອງກະລຶມ ແຂວງເຊກອງ ໃນເນື້ອທີ່ 298,12 ຕາລາງກິໂລແມັດ. ໃຊ້ທຶນໃນການຂຸດຄົ້ນທັງໝົດຫຼາຍກວ່າ 942.000 ໂດລາສະຫາລັດ.",
    english:
      "Conducting exploration and exploration activities for gold ore in Kaleum District, Sekong Province in an area of 297.68 square kilometers. Spending more than 942.000 dollars on the total mining operation.",
    chiness:
      "開展金礦勘查勘探活動 在卡勞姆區 色貢省面積 298.12平方公里。在整個採礦業務上花費超過 942.000 美元。",
  },
  subsiContact: {
  ...
  organizeChartImg: "/images/subsi/kaluem/organizational-chart.jpg",
  subsiImage: [
    {
      img: "/images/subsi/kaluem/organizational-chart.jpg",
      description: {
        lao: "ໂຄງຮ່າງການຈັດຕັ້ງຂອງ ບໍລິສັດ ດວງຈະເລີນ ພັດທະນາແຮ່ຄຳດາກຈຶງ ຈຳກັດ",
        english:
          "ORGANIZATIONAL CHART OF DUANGCHALERN DEVELOPMENT KALUEM GOLD MINING CO., LTD",
        chiness:
          "ORGANIZATIONAL CHART OF DUANGCHALERN DEVELOPMENT KALUEM GOLD MINING CO., LTD",
      },
    },
    {
      img: "/images/subsi/kaluem/gold-exploration-1.jpg",
      description: {
    ...
    {
      img: "/images/subsi/kaluem/gold-exploration-2.jpg",
      description: {
    ...
    {
      img: "/images/subsi/kaluem/gold-exploration-3.jpg",
      description: {
...
function MiningKaluemPage({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default MiningKaluemPage;
