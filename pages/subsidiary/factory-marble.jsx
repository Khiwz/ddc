...
const pageInfo = {
  ...
  subsiName: {
    lao: "ໂຮງງານຫັດຖະກຳ ແລະ ແກະສະຫຼັກຫີນອ່ອນ ດວງຈະເລີນພັດທະນາ ຈຳກັດ ຜູ້ດຽວ.",
    english: "DUANGCHALERN DEVELOPMENT CRAFT AND CARVE MARBLE FACTORY SOLE LTD",
    chiness: "DUANGCHALERN DEVELOPMENT CRAFT AND CARVE MARBLE FACTORY SOLE LTD",
  },
  subsiDescription: {
    lao: "ຈັດຈຳໜ່າຍ  ແລະ ຮັບຕິດຕັ້ງຫີນອ່ອນ, ຫີນແກຣນນິກ, ຫີນທຳມະຊາດທຸກຊະນິດ ມີທັງຂະໜາດມາດຕະຖານ ແລະ ຂະໜາດສັ່ງຕັດຕາມລູກຄ້າຕ້ອງການ.",
    english:
      "Distribution and installation of marble, granite, and all types of natural stone with both standard sizes and cut-to-order sizes according to customer needs.",
    chiness:
      "根據客戶需求，分銷和安裝標準尺寸和定制尺寸的大理石、花崗岩和所有類型的天然石材。",
  },
  subsiImage: [
    {
      img: "/images/subsi/marble/marble-1.jpg",
      description: {
        lao: "",
        english: "",
        chiness: "",
    ...
    {
      img: "/images/subsi/marble/marble-2.jpg",
      description: {
        lao: "",
        english: "",
        chiness: "",
    ...
    {
      img: "/images/subsi/marble/marble-3.jpg",
      description: {
        lao: "",
        english: "",
        chiness: "",
    ...
    {
      img: "/images/subsi/marble/marble-4.jpg",
      description: {
        lao: "",
        english: "",
        chiness: "",
...
function FactoryMarblePage({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default FactoryMarblePage;
