...
const pageInfo = {
  subsiName: {
    lao: "ບໍລິສັດ ນ້ຳຮາວຈະເລີນພາວເວີ້ ຈຳກັດ",
    english: "Nam Hao Chalern Power",
    chiness: "ບໍລິສັດ ນ້ຳຮາວຈະເລີນພາວເວີ້ ຈຳກັດ",
  },
  subsiDescription: {
  ...
  subsiImage: [
    {
      img: "/images/subsi/nam-hao/organizational-chart.jpg",
      description: {
        lao: "ໂຄງຮ່າງການຈັດຕັ້ງຂອງ ບໍລິສັດ ນ້ຳຮາວຈະເລີນພາວເວີ້ ຈຳກັດ",
        english:
          "Organizational structure of Nam Hao Chalern Power Company Limited",
  ...
  address: {
    lao: "ບ້ານ ນາຍົມ. ເມືອງ ຊຳເໝືອ. ແຂວງ ຫົວພັນ",
    english: "Nayom Village, SamNeur District. Huaphan Province",
    chiness: "村莊 三木區 華潘省",
  },
  workingHour: {
...
function EnergyNamhaoPage({ headerData }) {
  return (
    <div>
      <HeaderModel
...
export default EnergyNamhaoPage;
